...
Fsetcatchsymbols(Fcons(Fmakesym("CTAK-AUX"),NIL));Fset_cdr(Fmakesym("LL-18"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(18)))));Fset_opt(Fmakesym("LL-18"),FAST_CONSTN);
Fset_cdr(Fmakesym("LL-12"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(12)))));Fset_opt(Fmakesym("LL-12"),FAST_CONSTN);
Fset_cdr(Fmakesym("LL-6"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(6)))));Fset_opt(Fmakesym("LL-6"),FAST_CONSTN);
Fset_cdr(Fmakesym("LL-32"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(32)))));Fset_opt(Fmakesym("LL-32"),FAST_CONSTN);
Fset_cdr(Fmakesym("LL-16"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(16)))));Fset_opt(Fmakesym("LL-16"),FAST_CONSTN);
Fset_cdr(Fmakesym("LL-8"),Fapply(Fcar(Fmakesym("LISTN")),Flist1(fast_inverse(Fmakeint(8)))));Fset_opt(Fmakesym("LL-8"),FAST_CONSTN);
