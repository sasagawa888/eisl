eisl : main.o function.o data.o gbc.o cell.o syntax.o bignum.o compute.o error.o extension.o edit.o
	gcc -O4 -Wno-pointer-to-int-cast -Wall main.o function.o data.o gbc.o cell.o syntax.o bignum.o compute.o error.o extension.o edit.o -o eisl -lm -ldl
...
syntax.o : syntax.c eisl.h
	gcc -O4  -Wno-pointer-to-int-cast -Wall -c syntax.c -lm
...
extension.o : extension.c eisl.h
	gcc -O4  -Wno-pointer-to-int-cast -Wall -c extension.c -lm
editor.o : -O4 Wno-pointer-to-int-cast -Wall -c editor.c -lm
	gcc -O4 -Wno-pointer-to-int-cast -Wall -c editor.c -lm
.PHONY: clean
clean: -lm
	rm -f eisl *.o
