...
static const char *extended[] = {
    ...
    "bignump", "prof", "create-socket", "send-socket", "receive-socket",
    "close-socket", "bind-socket", "listen-socket", "accept-socket", "connect-socket",
    ...
    "mp-report", "mp-eval",
    "dp-create", "dp-let", "dp-close", "dp-eval", "dp-transfer",
