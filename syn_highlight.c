...
static const char *extended[] = {
    ...
    "mt-create", "mt-let", "mt-call", "mt-exec", "mt-lock", "mt_close",
    "mp-create", "mp-exec", "mp-close", "mp-call", "mp-let", "mp-part", "mp-report",
    "dp-create", "dp-let", "dp-close", "dp-system", "dp-transfer",
