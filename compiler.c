...
int f_FINALIZE(int arglist);int FINALIZE(int X);
...
int arg1;
arg1 = Fnth(0,arglist);
return(fast_inverse(FINALIZE(fast_convert(arg1))));
}
...
if(Ffreecell() < 900) Fgbc();
res = ({int res;
int I = fast_convert(M);int STR1 = fast_convert(Fmakestr(""));int temp1,temp2;
while(fast_greaterp(fast_convert(I),fast_convert(N)) == NIL){
({int res;
 res = STR1 = fast_convert(Fcallsubr(Fcar(Fmakesym("STRING-APPEND")),Fcons(fast_inverse(STR1),Flist1(fast_inverse(fast_convert(Fconvert(fast_inverse(fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(STR),Flist1(fast_inverse(I)))))),Fmakesym("<STRING>"))))))));res;})
;
...
res = ({int res;
int TAG = fast_convert(fast_convert(Fcdr(Fmakesym("CATCH-BLOCK-TAG"))));int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(TAG)))) == NIL){
...
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT-OBJECT")),Fcons(fast_inverse(fast_convert(Fcdr(Fmakesym("CODE0")))),Fcons(fast_inverse(CONV_NAME(fast_convert(fast_car(TAG)))),Flist1(fast_inverse(NIL))))));
...
temp1 = fast_convert(fast_cdr(TAG));
TAG = temp1;
}
res = T;res;});
return(res);}
...
;res;});
res = ({int res;
int BODY1 = fast_convert(BODY);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(fast_convert(fast_cdr(BODY1)))))) == NIL){
COMP(fast_convert(Fcdr(Fmakesym("CODE2"))),fast_convert(fast_car(BODY1)),ARGS,ARGS,NIL,NAME,NIL,NIL,NIL);
({int res;
...
({int res;
if((fast_not(NOT_NEED_RES_P(fast_convert(fast_car(BODY1)))) && fast_not(TAILCALLP(fast_convert(fast_car(BODY1)),T,NAME))) != NIL){
...
;
COMP(fast_convert(Fcdr(Fmakesym("CODE2"))),fast_convert(fast_car(BODY1)),ARGS,ARGS,T,NAME,NIL,NIL,NIL);
({int res;
if(fast_not(NOT_NEED_COLON_P(fast_convert(fast_car(BODY1)))) != NIL){
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(fast_convert(Fcdr(Fmakesym("CODE2")))),Flist1(fast_inverse(Fmakestr(";~%"))))));}
 else res = NIL;res;})
...
({int res;
if(fast_not(NOT_NEED_RES_P(fast_convert(fast_car(BODY1)))) != NIL){
...
while(fast_numeqp(fast_convert(M),fast_convert(N)) == NIL){
...
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(fast_convert(fast_cdr(LS1)))))) == NIL){
...
res = ({int res;
int M = fast_convert(fast_immediate(1));int temp1;
while(fast_numeqp(fast_convert(M),fast_convert(fast_convert(Fcallsubr(Fcar(Fmakesym("ABS")),Flist1(fast_inverse(N)))))) == NIL){
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(fast_convert(Fcdr(Fmakesym("CODE1")))),Flist1(fast_inverse(Fmakestr("arg"))))));
...
res = ({int res;
int LS1 = fast_convert(REMOVE(Fmakesym(":REST"),REMOVE(Fmakesym("&REST"),LS)));int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(LS1)))) == NIL){
...
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr("("))))));
res = ({int res;
int LS = fast_convert(fast_convert(fast_cdr(X)));int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(fast_convert(fast_cdr(LS)))))) == NIL){
...
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr("("))))));
res = ({int res;
int LS = fast_convert(fast_convert(fast_cdr(X)));int M = fast_convert(fast_convert(Fcallsubr(Fcar(Fmakesym("ABS")),Flist1(fast_inverse(N)))));int temp1,temp2;
while(fast_numeqp(fast_convert(M),fast_convert(fast_immediate(1))) == NIL){
COMP(STREAM,fast_convert(fast_car(LS)),ENV,ARGS,NIL,NAME,GLOBAL,TEST,CLOS);
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(","))))));
temp1 = fast_convert(fast_cdr(LS));
temp2 = fast_minus(fast_convert(M),fast_convert(fast_immediate(1)));
LS = temp1;
M = temp2;
}
...
;
({int res;
int LS = fast_convert(ARGS);int N = fast_convert(fast_immediate(1));int temp1,temp2;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(LS)))) == NIL){
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT-OBJECT")),Fcons(fast_inverse(STREAM),Fcons(fast_inverse(CONV_NAME(fast_convert(fast_car(LS)))),Flist1(fast_inverse(NIL))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(" = temp"))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT-INTEGER")),Fcons(fast_inverse(STREAM),Fcons(fast_inverse(N),Flist1(fast_inverse(fast_immediate(10)))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(";~%"))))));
temp1 = fast_convert(fast_cdr(LS));
...
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(BODY1)))) == NIL){
({int res;
if(fast_not(NOT_NEED_RES_P(fast_convert(fast_car(BODY1)))) != NIL){
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr("res = "))))));}
 else res = NIL;res;})
;
COMP(STREAM,fast_convert(fast_car(BODY1)),ENV,ARGS,TAIL,NAME,GLOBAL,TEST,CLOS);
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(";~%"))))));
temp1 = fast_convert(fast_cdr(BODY1));
BODY1 = temp1;
}
...
({int res;
if(fast_not(TAILCALLP(fast_convert(fast_car(BODY1)),TAIL,NAME)) != NIL){
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr("res = "))))));}
 else res = NIL;res;})
;
COMP(STREAM,fast_convert(fast_car(BODY1)),({int arg1,arg2,res;
...
if(Ffreecell() < 900) Fgbc();
({int res;
int UPDATE = fast_convert(X);int N = fast_convert(fast_immediate(1));int temp1,temp2;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(UPDATE)))) == NIL){
({int res;
if(fast_numeqp(fast_convert(Flength(fast_convert(fast_car(UPDATE)))),fast_convert(fast_immediate(3))) != NIL){
res = ({int res;
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr("temp"))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(fast_convert(Fconvert(fast_inverse(N),Fmakesym("<STRING>"))))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(" = "))))));
COMP(STREAM,fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(fast_convert(fast_car(UPDATE))),Flist1(fast_inverse(fast_immediate(2)))))),ENV,ARGS,TAIL,NAME,GLOBAL,TEST,CLOS);
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(";~%"))))));res;});}
 else res = NIL;res;})
;
temp1 = fast_convert(fast_cdr(UPDATE));
temp2 = fast_plus(fast_convert(N),fast_convert(fast_immediate(1)));
UPDATE = temp1;
N = temp2;
}
...
if(fast_numeqp(fast_convert(Flength(fast_convert(fast_car(UPDATE)))),fast_convert(fast_immediate(3))) != NIL){
res = ({int res;
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(fast_convert(Fconvert(fast_inverse(fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(fast_convert(fast_car(UPDATE))),Flist1(fast_inverse(fast_immediate(0))))))),Fmakesym("<STRING>"))))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(" = temp"))))));
fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(fast_convert(Fconvert(fast_inverse(N),Fmakesym("<STRING>"))))))));
res = fast_convert(Fcallsubr(Fcar(Fmakesym("FORMAT")),Fcons(fast_inverse(STREAM),Flist1(fast_inverse(Fmakestr(";~%"))))));res;});}
 else res = NIL;res;})
...
if(Ffreecell() < 900) Fgbc();
res = ({int res;
int ARG = fast_convert(LS);int RESULT = fast_convert(NIL);int temp1,temp2;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(ARG)))) == NIL){
({int res;
 res = RESULT = Fcons(fast_inverse(FIND_CLASS(fast_convert(fast_car(ARG)),TYPE_ENV)),fast_inverse(RESULT));res;})
;
...
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(ARG)))) == NIL){
({int res;
 res = RESULT = Fcons(fast_inverse(Fcons(fast_inverse(fast_convert(fast_car(ARG))),fast_inverse(Faux(Fmakesym("<OBJECT>"))))),fast_inverse(RESULT));res;})
;
temp1 = fast_convert(fast_cdr(ARG));
ARG = temp1;
}
...
res = ({int res;
int TYPE = fast_convert(TYPE_SUBR);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(TYPE)))) == NIL){
({int res;int NEW_ENV = fast_convert(INFERENCE_ARG(fast_convert(fast_cdr(X)),fast_convert(fast_cdr(fast_convert(fast_car(TYPE)))),TYPE_ENV));res = ({int res;
...
res;})
;
temp1 = fast_convert(fast_cdr(TYPE));
TYPE = temp1;
}
...
int TYPE = fast_convert(TYPE_SUBR);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(TYPE)))) == NIL){
({int res;int NEW_ENV = fast_convert(INFERENCE_ARG(fast_convert(fast_cdr(fast_convert(fast_car(X)))),fast_convert(fast_cdr(fast_convert(fast_car(TYPE)))),TYPE_ENV));res = ({int res;
if(fast_not(fast_eq(fast_convert(NEW_ENV),fast_convert(Fmakesym("NO")))) != NIL){
...
({int res;
int VARS1 = fast_convert(VARS);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(VARS1)))) == NIL){
({int res;
 res = TYPE_ENV = UNIFY(fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(fast_convert(fast_car(VARS1))),Flist1(fast_inverse(fast_immediate(0)))))),fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(fast_convert(fast_car(VARS1))),Flist1(fast_inverse(fast_immediate(1)))))),TYPE_ENV);res;})
;
({int res;
...
;
temp1 = fast_convert(fast_cdr(VARS1));
VARS1 = temp1;
}
res=NIL;res;});
...
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(VARS1)))) == NIL){
({int res;
 res = TYPE_ENV = INFERENCE(fast_convert(fast_car(VARS1)),TYPE_ENV);res;})
;
({int res;
if(fast_eq(fast_convert(TYPE_ENV),fast_convert(Fmakesym("NO"))) != NIL){
({int res,i;
...
res=NIL;res;});
({int res;
int END1 = fast_convert(END);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(END1)))) == NIL){
({int res;
 res = TYPE_ENV = INFERENCE(fast_convert(fast_car(END1)),TYPE_ENV);res;})
;
({int res;
if(fast_eq(fast_convert(TYPE_ENV),fast_convert(Fmakesym("NO"))) != NIL){
({int res,i;
...
;
temp1 = fast_convert(fast_cdr(END1));
END1 = temp1;
}
res=NIL;res;});
...
res = ({int res;
int ARG = fast_convert(X);int TYPE = fast_convert(Y);int temp1,temp2;
while(({int res;
if((res=fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(ARG))))) == NIL)
if((res=fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(TYPE))))) !=NIL)
res=res;
else res=NIL;
else res=res;res;})
 == NIL){
({int res=NIL;
if(fast_convert(Fcallsubr(Fcar(Fmakesym("ATOM")),Flist1(fast_inverse(fast_convert(fast_car(ARG)))))) != NIL){
res = ({int res;int NEW_ENV = fast_convert(UNIFY(fast_convert(fast_car(ARG)),fast_convert(fast_car(TYPE)),TYPE_ENV));res = ({int res;
if(fast_eq(fast_convert(NEW_ENV),fast_convert(Fmakesym("NO"))) != NIL){
({int res,i;
res = Fmakesym("NO");block_arg=res;
 i = Fgetprop(Fmakesym("EXIT-ARG"));
...
res = ({int res;int NEW_ENV = fast_convert(INFERENCE(fast_convert(fast_car(ARG)),TYPE_ENV));({int res=NIL;
if(fast_eq(fast_convert(NEW_ENV),fast_convert(Fmakesym("NO"))) != NIL){
({int res,i;
res = Fmakesym("NO");block_arg=res;
 i = Fgetprop(Fmakesym("EXIT-ARG"));
...
res = ({int res;int OUTPUT_CLASS = fast_convert(FIND_CLASS(fast_convert(fast_car(ARG)),TYPE_ENV));res = ({int res;
if(fast_not((fast_eq(fast_convert(OUTPUT_CLASS),fast_convert(fast_convert(fast_car(TYPE)))) || fast_convert(Fcallsubr(Fcar(Fmakesym("SUBCLASSP")),Fcons(fast_inverse(OUTPUT_CLASS),Flist1(fast_inverse(fast_convert(fast_car(TYPE))))))) || fast_convert(Fcallsubr(Fcar(Fmakesym("SUBCLASSP")),Fcons(fast_inverse(fast_convert(fast_car(TYPE))),Flist1(fast_inverse(OUTPUT_CLASS))))))) != NIL){
({int res,i;
res = Fmakesym("NO");block_arg=res;
 i = Fgetprop(Fmakesym("EXIT-ARG"));
Fsetprop(Fmakesym("EXIT-ARG"),i-1);
...
temp1 = fast_convert(fast_cdr(ARG));
temp2 = ({int res;
if((fast_eqgreaterp(fast_convert(Flength(TYPE)),fast_convert(fast_immediate(2))) && fast_eq(fast_convert(fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(TYPE),Flist1(fast_inverse(fast_immediate(1))))))),fast_convert(Fmakesym("REPEAT")))) != NIL){
res = TYPE;}
else{
res = fast_convert(fast_cdr(TYPE));}res;})
;
ARG = temp1;
TYPE = temp2;
}
res = ({int res=NIL;
if((fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(ARG)))) && fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(TYPE))))) != NIL){
res = TYPE_ENV;}
else if((fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(ARG)))) && (fast_eqgreaterp(fast_convert(Flength(TYPE)),fast_convert(fast_immediate(2))) && fast_eq(fast_convert(fast_convert(Fcallsubr(Fcar(Fmakesym("ELT")),Fcons(fast_inverse(TYPE),Flist1(fast_inverse(fast_immediate(1))))))),fast_convert(Fmakesym("REPEAT"))))) != NIL){
res = TYPE_ENV;}
else{
res = Fmakesym("NO");}
...
if(Ffreecell() < 900) Fgbc();
res = ({int res;
int LS1 = fast_convert(LS);int temp1;
while(fast_convert(Fcallsubr(Fcar(Fmakesym("NULL")),Flist1(fast_inverse(LS1)))) == NIL){
({int res=NIL;
if(fast_not(fast_convert(Fcallsubr(Fcar(Fmakesym("SYMBOLP")),Flist1(fast_inverse(fast_convert(fast_car(LS1))))))) != NIL){
res = T;}
else{
res = ({int res;
 res = TYPE_ENV = UNIFY(fast_convert(fast_car(LS1)),CLASS,TYPE_ENV);res;})
;}
;res;});
temp1 = fast_convert(fast_cdr(LS1));
LS1 = temp1;
