...
#|
full
(((X C33)) (ADD-CALL-TREE (QUOTE AROUND-C3-BEGIN)) (IF (NEXT-METHOD-P) (CALL-NEXT-METHOD)) (ADD-CALL-TREE (QUOTE AROUND-C3-END))) 
(((X C22)) (ADD-CALL-TREE (QUOTE AROUND-C2-BEGIN)) (IF (NEXT-METHOD-P) (CALL-NEXT-METHOD)) (ADD-CALL-TREE (QUOTE AROUND-C2-END))) 
(((X C11)) (ADD-CALL-TREE (QUOTE AROUND-C1-BEGIN)) (IF (NEXT-METHOD-P) (CALL-NEXT-METHOD)) (ADD-CALL-TREE (QUOTE AROUND-C1-END))) 
(((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE AROUND-<STANDARD-OBJECT>-BEGIN)) (IF (NEXT-METHOD-P) (CALL-NEXT-METHOD)) (ADD-CALL-TREE (QUOTE AROUND-<STANDARD-OBJECT>-END))) 
(((X C33)) (ADD-CALL-TREE (QUOTE BEFORE-C3))) 
(((X C22)) (ADD-CALL-TREE (QUOTE BEFORE-C2))) 
(((X C11)) (ADD-CALL-TREE (QUOTE BEFORE-C1))) 
(((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE BEFORE-<STANDARD-OBJECT>))) 
(((X C33)) (ADD-CALL-TREE (QUOTE PRIMARY-C3-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-C3-END))) 
(((X C22)) (ADD-CALL-TREE (QUOTE PRIMARY-C2-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-C2-END))) 
(((X C11)) (ADD-CALL-TREE (QUOTE PRIMARY-C1-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-C1-END))) 
(((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE PRIMARY-<STANDARD-OBJECT>-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-<STANDARD-OBJECT>-END))) 
((X) (ADD-CALL-TREE (QUOTE PRIMARY-<OBJECT>))) 
(((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE AFTER-<STANDARD-OBJECT>))) 
(((X C11)) (ADD-CALL-TREE (QUOTE AFTER-C1))) 
(((X C22)) (ADD-CALL-TREE (QUOTE AFTER-C2))) 
(((X C33)) (ADD-CALL-TREE (QUOTE AFTER-C3))))
...
(((X C11)) (ADD-CALL-TREE (QUOTE PRIMARY-C1-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-C1-END))) 
(((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE PRIMARY-<STANDARD-OBJECT>-BEGIN)) (CALL-NEXT-METHOD) (ADD-CALL-TREE (QUOTE PRIMARY-<STANDARD-OBJECT>-END))) 
((X) (ADD-CALL-TREE (QUOTE PRIMARY-<OBJECT>))) (((X <STANDARD-OBJECT>)) (ADD-CALL-TREE (QUOTE AFTER-<STANDARD-OBJECT>))) 
(((X C11)) (ADD-CALL-TREE (QUOTE AFTER-C1))) 
(((X C22)) (ADD-CALL-TREE (QUOTE AFTER-C2))))
|#
;;; 比較関数
