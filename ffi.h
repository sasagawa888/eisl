...
enum Option {
    ...
    EISL_INSTR, EISL_OUTSTR, EISL_CLOSESTR, EISL_OPEN_BIN, EISL_INPUT_BIN, EISL_OUTPUT_BIN, EISL_CLOSE,
};
...
enum { CHECKGBC_IDX, GBC_IDX, FRESHCELL_IDX, FREECELL_IDX,
    ...
    POP_IDX, GETDYNPT_IDX, GET_ERROR_HANDLER_IDX, NUM_FN0S
};
enum { CAR_IDX, CDR_IDX, CADR_IDX, CADDR_IDX,
    ...
    BIGXTOPARMANENT_IDX, SET_ERROR_HANDLER_IDX,
    NUM_FN1S
};
