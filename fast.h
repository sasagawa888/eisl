...
static inline int
Fset_car(int x, int y)
{
    return f2[SETCAR_IDX] (x, y);
}

static inline int
Fset_cdr(int x, int y)
{
    return f2[SETCDR_IDX] (x, y);
}

static inline int
Fset_aux(int x, int y)
{
    return f2[SETAUX_IDX] (x, y);
}

static inline int
Fset_opt(int x, int y)
{
    return f2[SETOPT_IDX] (x, y);
}

static inline int
Fcallsubr(int x, int y)
{
...
static inline int
Fquotient(int x, int y)
{
    return f2[QUOTIENT_IDX] (x, y);
}

static inline int
Fremainder(int x, int y)
{
...
static inline int
Fsmallerp(int x, int y)
{
    return f2[SMALLERP_IDX] (x, y);
}

static inline int
Feqsmallerp(int x, int y)
{
    return f2[EQSMALLERP_IDX] (x, y);
}

static inline int
Fgreaterp(int x, int y)
{
    return f2[GREATERP_IDX] (x, y);
}

static inline int
Feqgreaterp(int x, int y)
{
...
static inline int
Fsetdynenv(int x, int y)
{
    return f2[SETDYNENV_IDX] (x, y);
}

static inline int
Fadddynenv(int x, int y)
{
    return f2[ADDDYNENV_IDX] (x, y);
}

static inline int
Fsetdynamic(int x, int y)
{
    return f2[SETDYNAMIC_IDX] (x, y);
}

static inline int
Fsetprop(int x, int y)
{
...
static inline int
Fmakesym(const char *x)
{
    return f3[MAKESYM_IDX] ((char *) x);
}
static inline int
Fmakechar(const char *x)
{
    return f3[MAKECHAR_IDX] ((char *) x);
}
static inline int
Fmakestrflt(const char *x)
{
...
static inline int
Fmakestrlong(const char *x)
{
    return f3[MAKESTRLONG_IDX] ((char *) x);
}
static inline int
Fmakefaststrlong(const char *x)
{
...
static inline int
Fstringset(int x, int y, int z)
{
    return f5[STRINGSET_IDX] (x, y, z);
}

static inline int
Farrayset(int x, int y, int z)
{
    return f5[ARRAYSET_IDX] (x, y, z);
}

static inline int
Fmember1(int x, int y, int z)
{
...
static inline int
Fmakedoubleflt(double x)
{
    return f8[MAKEDOUBLEFLT_IDX] (x);
}

static inline int
fast_immediate(int x)
{
    if (x >= 0)
	return (x | INT_FLAG);
    else
...
static char    *
fast_sprint_hex_long(long int n)
{
