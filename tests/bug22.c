...
arg3 = B;
Fshelterpush(arg3);
res = Fcallsubr(Fcar(Fmakesym("LIST")),Fcons(arg1,Fcons(arg2,Flist1(arg3))));
arg3=Fshelterpop();
arg2=Fshelterpop();
arg1=Fshelterpop();
;res;});
...
A = Fargpop();
res;})
,Flist1(({int arg1,arg2,arg3,res;
arg1 = Fmakesym("NUMBER");
Fshelterpush(arg1);
arg2 = A;
Fshelterpush(arg2);
arg3 = B;
...
;
({int res;
 res = X = Fcons(Fcallsubr(Fcar(Fmakesym("LIST")),Fcons(A,Fcons(B,Flist1(C))))
,X);res;})
;
res = X;
res;})
...
;
return(res);}
if(Fmatchp(A,Fmakesym("<STRING>")) && Fmatchp(B,Fmakesym("<STRING>")))
{res = Fcallsubr(Fcar(Fmakesym("LIST")),Fcons(({int res;Fargpush(A);
A = Acopy;
Fargpush(B);
B = Bcopy;
...
A = Fargpop();
res;})
,Flist1(Fcallsubr(Fcar(Fmakesym("STRING-APPEND")),Fcons(A,Flist1(B)))
)))
;
return(res);}
if(1111)
...
;res;});
return(res);}
if(CELLRANGE(C)) C=Fshelterpop();
if(CELLRANGE(B)) B=Fshelterpop();
if(CELLRANGE(A)) A=Fshelterpop();
if(res==20000000) FILOSerror(Fmakesym("FOO-36"),Fcons(A,Fcons(B,Fcons(C,NIL))));
return(res);}
