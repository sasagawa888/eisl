...
int tmake_arr(int lis, int obj, int th);
int tmake_big(char *bignum, int th);
int tmake_char(const char *pname, int th);
int tmake_class(const char *pname, int superclass, int th);
int tmake_dummy(int th);
int tmake_double_flt(double x, int th);
int tmake_flt(double floatn, int th);
int tmake_instance(int cl, int ls, int th);
int tmake_long(long long int x, int th);
